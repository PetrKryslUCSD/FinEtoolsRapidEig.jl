...
# neigvss  = [150, 300, 600, 1200]
# for jsn = [
# 	"Redalu_cyl-cylinder-7_5mm-31692el_mesh-neigvs=150-LegendreBasis-a=1_5-b=6_9-Nc=8-tol=0_05.json",                                                                               
# 	"Redalu_cyl-cylinder-7_5mm-31692el_mesh-neigvs=300-LegendreBasis-a=1_5-b=6_9-Nc=16-tol=0_05.json",                                                                              
# 	"Redalu_cyl-cylinder-7_5mm-31692el_mesh-neigvs=600-LegendreBasis-a=1_5-b=6_9-Nc=32-tol=0_05.json",            
# 	"Redalu_cyl-cylinder-7_5mm-31692el_mesh-neigvs=1200-LegendreBasis-a=1_5-b=6_9-Nc=64-tol=0_05.json",                                                                             
# 	]
# 	updatets!(tfs, timingtotalfull, jsn)
# 	updatets!(trs1, timingtotal, jsn)
# end
...
# 	updatets!(trs2, timingtotal, jsn)
# end
# figurename = getcleanname("Redalu_cyl-cylinder-7_5mm-31692el_mesh-neigvs=$(neigvss)-LegendreBasis-a=1_5-tol=0_05-0_005") * ".pdf"

# neigvss  = [150, 300, 600, 1200]
# for jsn = [
# 	"Redalu_cyl-cylinder-nr=25xnL=100_mesh-neigvs=150-LegendreBasis-a=1_5-b=6_9-Nc=8-tol=0_05.json",                                                                                
# 	"Redalu_cyl-cylinder-nr=25xnL=100_mesh-neigvs=300-LegendreBasis-a=1_5-b=6_9-Nc=16-tol=0_05.json",                                                                               
# 	"Redalu_cyl-cylinder-nr=25xnL=100_mesh-neigvs=600-LegendreBasis-a=1_5-b=6_9-Nc=32-tol=0_05.json",   
# 	"Redalu_cyl-cylinder-nr=25xnL=100_mesh-neigvs=1200-LegendreBasis-a=1_5-b=6_9-Nc=64-tol=0_05.json",                                                                              
# 	]
# 	updatets!(tfs, timingtotalfull, jsn)
# 	updatets!(trs1, timingtotal, jsn)
# end
...
# 	updatets!(trs2, timingtotal, jsn)
# end
# figurename = getcleanname("Redalu_cyl-cylinder-nr=25xnL=100_mesh-neigvs=$(neigvss)-LegendreBasis-a=1_5-tol=0_05-0_005") * ".pdf"
...
@. trs1 = tfs / trs1
@. trs2 = tfs / trs2
push!(plots, redtimpl1(neigvss, trs1), redtimpl2(neigvss, trs2))
